      ...
      <div className="bg-[var(--card)] border border-[var(--card-border)] rounded-xl p-8">
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center text-xs text-slate-500">
            <span className="bg-[var(--card)] px-2">or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full h-10 rounded-lg text-sm font-medium border border-[var(--card-border)] bg-transparent text-[var(--foreground)] hover:bg-slate-800/50 transition-colors duration-150 flex items-center justify-center gap-2 disabled:opacity-60"
        >
          {googleLoading ? (
